...
Read `~/.config/opencode/agents/shared/LOOP_PREVENTION.md`. Hard cap: 20 tool calls (31 rules needs more budget).
...
bash ~/.config/opencode/scripts/validators/validate-vendor-provenance.sh 2>/dev/null
```
